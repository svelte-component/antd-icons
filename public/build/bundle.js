    ...
    */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			html_tag.m(/*svgHtml*/ ctx[1], target, anchor);
    			insert_dev(target, html_anchor, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*svgHtml*/ 2) html_tag.p(/*svgHtml*/ ctx[1]);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("restProps" in $$props) $$invalidate(6, restProps = $$props.restProps);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("svgHtml" in $$props) $$invalidate(1, svgHtml = $$props.svgHtml);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*primaryColor, secondaryColor*/ 24) {
    			 if (primaryColor) {
    				$$invalidate(7, colors = {
    					primaryColor,
    		...
    		if ($$self.$$.dirty & /*icon, colors, style, restProps, className*/ 229) {
    			 $$invalidate(1, svgHtml = helpers.renderIconDefinitionToSVGElement(icon, {
    				placeholders: {
    	...
    	return [icon, svgHtml, style, primaryColor, secondaryColor, className, restProps];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	iconbase = new IconBase({
    			props: {
    				icon: /*icon*/ ctx[0],
    				primaryColor: /*primaryColor*/ ctx[8],
    				secondaryColor: /*secondaryColor*/ ctx[9],
    				className: /*svgClassString*/ ctx[6],
    				restProps: /*restSvgProps*/ ctx[3],
    				style: /*svgStyle*/ ctx[7]
    			},
    			$$inline: true
    		});
    	...
    	let span_levels = [
    		...
    		{
    			"aria-label": span_aria_label_value = /*icon*/ ctx[0].name
    		},
    		{ classname: /*classString*/ ctx[5] },
    		{ style: /*style*/ ctx[4] },
    		/*restProps*/ ctx[2]
    	];
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*primaryColor*/ 256) iconbase_changes.primaryColor = /*primaryColor*/ ctx[8];
    			if (dirty & /*secondaryColor*/ 512) iconbase_changes.secondaryColor = /*secondaryColor*/ ctx[9];
    			if (dirty & /*svgClassString*/ 64) iconbase_changes.className = /*svgClassString*/ ctx[6];
    			if (dirty & /*restSvgProps*/ 8) iconbase_changes.restProps = /*restSvgProps*/ ctx[3];
    			if (dirty & /*svgStyle*/ 128) iconbase_changes.style = /*svgStyle*/ ctx[7];
    			iconbase.$set(iconbase_changes);

    			set_attributes(span, span_data = get_spread_update(span_levels, [
    				{ role: "img" },
    				(!current || dirty & /*tabIndex*/ 2) && { tabindex: /*tabIndex*/ ctx[1] },
    				(!current || dirty & /*icon*/ 1 && span_aria_label_value !== (span_aria_label_value = /*icon*/ ctx[0].name)) && { "aria-label": span_aria_label_value },
    				(!current || dirty & /*classString*/ 32) && { classname: /*classString*/ ctx[5] },
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("icon" in $$props) $$invalidate(0, icon = $$props.icon);
    		if ("spin" in $$props) $$invalidate(11, spin = $$props.spin);
    		if ("rotate" in $$props) $$invalidate(12, rotate = $$props.rotate);
    		if ("tabIndex" in $$props) $$invalidate(1, tabIndex = $$props.tabIndex);
    		if ("twoToneColor" in $$props) $$invalidate(13, twoToneColor = $$props.twoToneColor);
    		if ("restProps" in $$props) $$invalidate(2, restProps = $$props.restProps);
    		if ("restSvgProps" in $$props) $$invalidate(3, restSvgProps = $$props.restSvgProps);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("restSvgProps" in $$props) $$invalidate(3, restSvgProps = $$props.restSvgProps);
    		if ("style" in $$props) $$invalidate(4, style = $$props.style);
    		if ("classString" in $$props) $$invalidate(5, classString = $$props.classString);
    		if ("svgClassString" in $$props) $$invalidate(6, svgClassString = $$props.svgClassString);
    		if ("svgStyle" in $$props) $$invalidate(7, svgStyle = $$props.svgStyle);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*icon, className*/ 1025) {
    			 $$invalidate(5, classString = classnames(
    				"anticon",
    				{
    		...
    		if ($$self.$$.dirty & /*spin, icon*/ 2049) {
    			 $$invalidate(6, svgClassString = classnames({
    				"anticon-spin": !!spin || icon.name === "loading"
    			}));
    		}

    		if ($$self.$$.dirty & /*rotate*/ 4096) {
    			 $$invalidate(7, svgStyle = rotate
    			? `msTransform: rotate(${rotate}deg);transform: rotate(${rotate}deg);`
    			: undefined);
    		}

    		if ($$self.$$.dirty & /*twoToneColor*/ 8192) {
    			 $$invalidate(8, [primaryColor, secondaryColor] = normalizeTwoToneColors(twoToneColor), primaryColor, ($$invalidate(9, secondaryColor), $$invalidate(13, twoToneColor)));
    		}
    	};
